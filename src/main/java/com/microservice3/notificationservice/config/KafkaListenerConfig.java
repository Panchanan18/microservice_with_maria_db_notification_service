package com.microservice3.notificationservice.config;
...
import com.microservice3.notificationservice.event.StudentSerDes;
...
public class KafkaListenerConfig {
    ...
    public ConsumerFactory<String, Student> consumerFactory(){
        ...
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, StudentSerDes.class);
